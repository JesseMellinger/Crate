...
describe("Testing Website", () => {
  ...
  it("Should be able to go to USER and see the account info", () => {
      ...
      cy.get("img:first")
        .should("have.attr", "src", "https://t3.ftcdn.net/jpg/03/67/46/48/360_F_367464887_f0w1JrL8PddfuH3P2jSPlIGjKU2BI0rn.jpg")
        .get("img:last")
        .should("have.attr", "src", "https://image.flaticon.com/icons/png/512/61/61456.png")
